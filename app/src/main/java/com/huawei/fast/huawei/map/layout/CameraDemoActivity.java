...
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.CameraPosition;
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.CameraUpdate;
...
public class CameraDemoActivity extends AppCompatActivity implements
        ExtendedMap.OnCameraMoveStartedListener,
        ExtendedMap.OnCameraMoveListener,
        ExtendedMap.OnCameraMoveCanceledListener,
        ExtendedMap.OnCameraIdleListener,
        OnMapReadyCallback {
    ...
    public void onGoToSydney(View view) {
        ...
        changeCamera(CameraUpdateFactory.newCameraPosition(SYDNEY), new ExtendedMap.CancelableCallback() {
            @Override
     ...
     */
    private void changeCamera(CameraUpdate update, ExtendedMap.CancelableCallback callback) {
    ...
    public void onCameraMoveStarted(int reason) {
        ...
        switch (reason) {
            case ExtendedMap.OnCameraMoveStartedListener.REASON_GESTURE:
                currPolylineOptions.color(Color.BLUE);
                reasonText = "GESTURE";
                break;
            case ExtendedMap.OnCameraMoveStartedListener.REASON_API_ANIMATION:
                currPolylineOptions.color(Color.RED);
                reasonText = "API_ANIMATION";
                break;
            case ExtendedMap.OnCameraMoveStartedListener.REASON_DEVELOPER_ANIMATION:
