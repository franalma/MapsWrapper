...
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.BitmapDescriptorFactory;
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.ButtCap;
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.CameraUpdateFactory;
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.Cap;
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.CustomCap;
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.Dash;
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.Dot;
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.ExtendedMap;
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.Gap;
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.JointType;
...
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.PatternItem;
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.Polyline;
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.PolylineOptions;
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.RoundCap;
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.SquareCap;
...
public class PolylineDemoActivity extends AppCompatActivity
    ...
    public void onMapReady(ExtendedMap map) {
        ...
        map.setOnPolylineClickListener(new ExtendedMap.OnPolylineClickListener() {
            @Override
