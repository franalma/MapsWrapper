...
public class CircleDemoActivity extends AppCompatActivity
        implements OnSeekBarChangeListener, ExtendedMap.OnMarkerDragListener, ExtendedMap.OnMapLongClickListener,
    ...
    public void onMapReady(ExtendedMap map) {
        ...
        map.setOnCircleClickListener(new ExtendedMap.OnCircleClickListener() {
            @Override
