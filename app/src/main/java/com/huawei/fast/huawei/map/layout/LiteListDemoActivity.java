...
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.MapView;
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.MapsInitializer;
...
public class LiteListDemoActivity extends AppCompatActivity {
    ...
    private class MapAdapter extends RecyclerView.Adapter<MapAdapter.ViewHolder> {
        ...
        class ViewHolder extends RecyclerView.ViewHolder implements OnMapReadyCallback {
            ...
            @Override
            public void onMapReady(ExtendedMap googleMap) {
            ...
            private void setMapLocation() {
                ...
                map.setMapType(ExtendedMap.MAP_TYPE_NORMAL);
            }
    ...
    private RecyclerView.RecyclerListener mRecycleListener = new RecyclerView.RecyclerListener() {
        ...
        public void onViewRecycled(RecyclerView.ViewHolder holder) {
            ...
            if (mapHolder != null && mapHolder.map != null) {
                ...
                // not be displayed.
                mapHolder.map.clear();
                mapHolder.map.setMapType(ExtendedMap.MAP_TYPE_NONE);
            }
        }
    };
