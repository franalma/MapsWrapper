...
import com.huawei.fast.huawei.map.hmsgmsmaplayout.wrapper.LocationSource;
...
public class LocationSourceDemoActivity extends AppCompatActivity implements OnMapReadyCallback {
     ...
     */
    private static class LongPressLocationSource implements LocationSource, ExtendedMap.OnMapLongClickListener {
