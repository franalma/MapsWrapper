...
public class Marker {
    ...
    public LatLng getPosition() {
        LatLng latLng = null;
        if (google != null) latLng = new LatLng(google.getPosition().latitude, google.getPosition().longitude);
        if (huawei != null) latLng = new LatLng(huawei.getPosition().latitude, huawei.getPosition().longitude);
        return latLng;
    }
