...
public class CameraUpdateFactory {
    ...
    public static CameraUpdate zoomBy(float value) {
        com.google.android.gms.maps.CameraUpdate google = null;
        com.huawei.hms.maps.CameraUpdate huawei = null;
        try {
            google = com.google.android.gms.maps.CameraUpdateFactory.zoomBy(value);
        } catch (Exception e) {
            e.printStackTrace();
        }
        try {
            huawei = com.huawei.hms.maps.CameraUpdateFactory.zoomBy(value);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static CameraUpdate zoomBy(float value, Point point) {
        com.google.android.gms.maps.CameraUpdate google = null;
        com.huawei.hms.maps.CameraUpdate huawei = null;
        try {
            google = com.google.android.gms.maps.CameraUpdateFactory.zoomBy(value, point);
        } catch (Exception e) {
            e.printStackTrace();
        }
        try {
            huawei = com.huawei.hms.maps.CameraUpdateFactory.zoomBy(value, point);
        } catch (Exception e) {
            e.printStackTrace();
        }
